    ...
    <>
      ...
      <Template backgroundImage="about" footer={true} header={true} headerColor={false}>
        ...
        <p className={styles.paragraph}>
          Я пишу это в надежде на то, что слово моё будет прочитано. Я убеждён, что истина — это александрийский стих
          или одиннадцатисложный. Что нужно взять палку; и пойти на вершину, как Боркман, как Рубек, как Брандт. Что
          аксиома: «Никто не может дать того, что не имеет», неприменима в области нравственного. Я верю в слова
          премудрого Соломона — мудрость в порочную душу не входит, знание, если не иметь совести, способно лишь
          погубить. Что нужно заступаться за поэзию вопреки её заступникам и защищать её от тех, кто её оправдывает. Что
          кто попробовал серьезного, тому шутка, в особенности скучная, уже не понравится. Что нет проку фабриковать
          хорошее железо, когда собственная душа полна шлака. Что нет пользы приводить в порядок земельное угодье, когда
          человек не в ладу с собой. Я всегда считал, что поэт дома должен узнавать по номерам, горы — по высоте, детей
          — по дате их рождения, корабли по именам, женщин по фамилиям любовников, мужчин по их недостаткам, животных по
          достоинствам, планеты по определениям в гороскопе, а звезды — по их влиянию на жизнь того, чье рождение они
          осеняли.
        </p>
        <p className={styles.paragraph}>
          ...
          Андреева. По своей сути, rosamundi — это исследование человеческого опыта через поэзию и приглашение к связи с
          высшей духовной реальностью. Каждая встреча человека с человеком — это возможность для роста и трансформации.
          Я глубоко убеждён, что rosamundi способна стать катализатором метаморфор внутри каждого из нас. Лично для меня
          rosamundi — это способ прикоснуться к этой высшей реальности, получить доступ к более глубоким брамфатурам,
          которые лежат под поверхностью нашей повседневной жизни.
        </p>
        <p className={styles.paragraph}>
